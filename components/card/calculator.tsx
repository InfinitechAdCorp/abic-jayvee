...
const LoanCalculator: React.FC = () => {
  ...
  const downloadTableAsPDF = () => {
    ...
    doc.setFontSize(8);
    const address = "Unit 202, Campos Rueda Building, 101 Urban Ave, Makati, 1206 Metro Manila";
  ...
  return (
    <div className="container mx-auto flex-grow max-w-7xl px-6 w-full flex flex-col gap-4">
      <Card>
        <CardBody>
      ...
      {!downloadSuccess && (
        <p>
          ...
          <a href="https://dmci-agent.vercel.app/calculator" target="_blank" rel="noopener noreferrer">
            online calculator
          </a>.
        </p>
      )}
